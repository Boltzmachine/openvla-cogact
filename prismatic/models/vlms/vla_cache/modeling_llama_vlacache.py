...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.config.proportion_attn_var = 0
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        pre_selected_reusable_patches = None,
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            ...
            if inputs_embeds.size(1) != 1 and layer_idx in self.pruning_loc:
                if pre_selected_reusable_patches is not None:
                    selected_reusable_patches = pre_selected_reusable_patches.squeeze(0)
                else:
...
class LlamaForCausalLMVLACache(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            cache_position=cache_position,
            pre_selected_reusable_patches=pre_selected_reusable_patches,
        )
